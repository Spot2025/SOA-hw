...
type Flight struct {
	...
	Origin         string                 `protobuf:"bytes,4,opt,name=origin,proto3" json:"origin,omitempty"`           // IATA код, например VKO, LED
	Destination    string                 `protobuf:"bytes,5,opt,name=destination,proto3" json:"destination,omitempty"` // IATA код
	...
	Price          string                 `protobuf:"bytes,10,opt,name=price,proto3" json:"price,omitempty"` // decimal как string для точности
...
type SearchFlightsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Origin        string                 `protobuf:"bytes,1,opt,name=origin,proto3" json:"origin,omitempty"`           // обязательный
	Destination   string                 `protobuf:"bytes,2,opt,name=destination,proto3" json:"destination,omitempty"` // обязательный
	Date          string                 `protobuf:"bytes,3,opt,name=date,proto3" json:"date,omitempty"`               // опционально, формат YYYY-MM-DD
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ReserveSeatsRequest struct {
	...
	BookingId     string                 `protobuf:"bytes,3,opt,name=booking_id,json=bookingId,proto3" json:"booking_id,omitempty"` // ID бронирования из Booking Service (для идемпотентности)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReserveSeatsResponse) GetReservationId() int64 {
	if x != nil {
...
func (x *ReserveSeatsResponse) GetBookingId() string {
	if x != nil {
		return x.BookingId
	}
	return ""
...
func (x *ReserveSeatsResponse) GetFlightId() int64 {
	if x != nil {
		return x.FlightId
	}
	return 0
...
func (x *ReserveSeatsResponse) GetSeatCount() int32 {
	if x != nil {
		return x.SeatCount
	}
	return 0
...
type ReleaseReservationResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	BookingId      string                 `protobuf:"bytes,1,opt,name=booking_id,json=bookingId,proto3" json:"booking_id,omitempty"`
	PreviousStatus ReservationStatus      `protobuf:"varint,2,opt,name=previous_status,json=previousStatus,proto3,enum=flight.v1.ReservationStatus" json:"previous_status,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ReleaseReservationResponse) GetBookingId() string {
	if x != nil {
		return x.BookingId
	}
	return ""
...
func (x *ReleaseReservationResponse) GetPreviousStatus() ReservationStatus {
	if x != nil {
...
const file_flight_proto_rawDesc = "" +
	"\n" +
	"\fflight.proto\x12\tflight.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa4\x03\n" +
	"\x06Flight\x12\x0e\n" +
	...
	"\x05price\x18\n" +
	" \x01(\tR\x05price\x12/\n" +
	"\x06status\x18\v \x01(\x0e2\x17.flight.v1.FlightStatusR\x06status\"d\n" +
	...
	"\x06flight\x18\x01 \x01(\v2\x11.flight.v1.FlightR\x06flight\"p\n" +
	"\x13ReserveSeatsRequest\x12\x1b\n" +
	"\tflight_id\x18\x01 \x01(\x03R\bflightId\x12\x1d\n" +
	"\n" +
	"seat_count\x18\x02 \x01(\x05R\tseatCount\x12\x1d\n" +
	"\n" +
	"booking_id\x18\x03 \x01(\tR\tbookingId\"\xce\x01\n" +
	"\x14ReserveSeatsResponse\x12%\n" +
	"\x0ereservation_id\x18\x01 \x01(\x03R\rreservationId\x12\x1d\n" +
	"\n" +
	"booking_id\x18\x02 \x01(\tR\tbookingId\x12\x1b\n" +
	"\tflight_id\x18\x03 \x01(\x03R\bflightId\x12\x1d\n" +
	"\n" +
	"seat_count\x18\x04 \x01(\x05R\tseatCount\x124\n" +
	"\x06status\x18\x05 \x01(\x0e2\x1c.flight.v1.ReservationStatusR\x06status\":\n" +
	"\x19ReleaseReservationRequest\x12\x1d\n" +
	"\n" +
	"booking_id\x18\x01 \x01(\tR\tbookingId\"\x82\x01\n" +
	"\x1aReleaseReservationResponse\x12\x1d\n" +
	"\n" +
	"booking_id\x18\x01 \x01(\tR\tbookingId\x12E\n" +
	"\x0fprevious_status\x18\x02 \x01(\x0e2\x1c.flight.v1.ReservationStatusR\x0epreviousStatus*\xa0\x01\n" +
	...
	"\x1aRESERVATION_STATUS_EXPIRED\x10\x032\xdf\x02\n" +
	"\rFlightService\x12R\n" +
	"\rSearchFlights\x12\x1f.flight.v1.SearchFlightsRequest\x1a .flight.v1.SearchFlightsResponse\x12F\n" +
	...
	"\x12ReleaseReservation\x12$.flight.v1.ReleaseReservationRequest\x1a%.flight.v1.ReleaseReservationResponseB(Z&soa-hw/proto/gen/go/flight/v1;flightv1b\x06proto3"
...
var file_flight_proto_goTypes = []any{
	...
	(*GetFlightResponse)(nil),          // 6: flight.v1.GetFlightResponse
	(*ReserveSeatsRequest)(nil),        // 7: flight.v1.ReserveSeatsRequest
	(*ReserveSeatsResponse)(nil),       // 8: flight.v1.ReserveSeatsResponse
	(*ReleaseReservationRequest)(nil),  // 9: flight.v1.ReleaseReservationRequest
	(*ReleaseReservationResponse)(nil), // 10: flight.v1.ReleaseReservationResponse
	(*timestamppb.Timestamp)(nil),      // 11: google.protobuf.Timestamp
}
var file_flight_proto_depIdxs = []int32{
	11, // 0: flight.v1.Flight.departure_time:type_name -> google.protobuf.Timestamp
	11, // 1: flight.v1.Flight.arrival_time:type_name -> google.protobuf.Timestamp
	0,  // 2: flight.v1.Flight.status:type_name -> flight.v1.FlightStatus
	2,  // 3: flight.v1.SearchFlightsResponse.flights:type_name -> flight.v1.Flight
	2,  // 4: flight.v1.GetFlightResponse.flight:type_name -> flight.v1.Flight
	1,  // 5: flight.v1.ReserveSeatsResponse.status:type_name -> flight.v1.ReservationStatus
	1,  // 6: flight.v1.ReleaseReservationResponse.previous_status:type_name -> flight.v1.ReservationStatus
	...
	7,  // 9: flight.v1.FlightService.ReserveSeats:input_type -> flight.v1.ReserveSeatsRequest
	9,  // 10: flight.v1.FlightService.ReleaseReservation:input_type -> flight.v1.ReleaseReservationRequest
	4,  // 11: flight.v1.FlightService.SearchFlights:output_type -> flight.v1.SearchFlightsResponse
	6,  // 12: flight.v1.FlightService.GetFlight:output_type -> flight.v1.GetFlightResponse
	8,  // 13: flight.v1.FlightService.ReserveSeats:output_type -> flight.v1.ReserveSeatsResponse
	10, // 14: flight.v1.FlightService.ReleaseReservation:output_type -> flight.v1.ReleaseReservationResponse
